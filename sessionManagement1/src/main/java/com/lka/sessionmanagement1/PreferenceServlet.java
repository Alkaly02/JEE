 ...
 */
package com.lka.sessionmanagement1;
...
//        processRequest(request, response);
        ...
        if(cookies != null){
            ...
            if(cookie.getName().equals("couleurPreferee")){
                couleurPreferee = (String)cookie.getValue();
            }
        }
        }
        response.setContentType("text/html;charset=UTF-8");
...
"            <label for=\"couleur\">Choisir votre theme</label>\n" +
"            <input id=\"couleur\" type=\"color\" name=\"couleur\" />\n" +
"            <input type=\"submit\" value=\"Definir\" />\n" +
"        </form>"
                    + "");
            out.println("<p>");
            out.println(couleurPreferee);
            out.println("</p>");
            out.println("</body>");
            out.println("</html>");
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
//        processRequest(request, response);
        String couleurPreferee = request.getParameter("couleur");
        Cookie cookie = new Cookie("couleurPreferee", couleurPreferee);
